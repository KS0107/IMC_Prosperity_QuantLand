...
PARAMS = {
    Product.RAINFOREST_RESIN: {
        "fair_value": 10000,
        "take_width": 1,
        "clear_width": 0.4, # Test 0.4, was 0.5
        "volume_limit": 0,
    },
    Product.KELP: {
        "take_width": 1,
        ...
        "adverse_volume": 20,
        "reversion_beta": -0.5,
        "kelp_min_edge": 1.65, # Test 1.65, was 1.6
    },
    Product.SPREAD1: {
        ...
        "zscore_threshold": 3,
        "target_position": 76, # Test 76, was 74
    },
    Product.SPREAD2: {
...
class Trader:
    ...
    def spread_orders(
        ...
        if basket_swmid == 0 or synthetic_swmid == 0:
            print(f"Invalid swmid for {basket_product}")
            return None
